        ...
        <div className="page-center">
          <div className={styles.footerInfo}>
            <div className={styles.copyrightLinks}>
              ...
              {/* Fallback to static legal links if none in API */}
              {(!footerData.legal_links || footerData.legal_links.length === 0) && (
                <>
                  <span className={styles.dot}>·</span>
                ...
                {socialLinks.map((social) => (
                  ...
                  >
                    {social.platform === 'facebook' && (
                      <img src={FacebookWhite} alt="" className={styles.socialIcon} />
                    )}
                    {social.platform === 'instagram' && (
                      <img src={InstagramWhite} alt="" className={styles.socialIcon} />
                    )}
                    {social.platform === 'linkedin' && (
                      <img src={LinkedinWhite} alt="" className={styles.socialIcon} />
                    )}
                  </a>
                ))}
              </div>
