    ...
    <footer className={styles.footer}>
      <div className={styles.footerContent}>
        <div className={styles.footerSection}>
          <img
            src="https://cdn.builder.io/api/v1/image/assets/3a5ff2c7562e4764a5a85cb40d9ea963/4b400847a38add2194a9f86e804b783280a735f7?apiKey=3a5ff2c7562e4764a5a85cb40d9ea963&"
            alt="Logo"
        ...
        <div className={styles.footerSection}>
          ...
          <ul className={styles.sectionList}>
            ...
            <li>
              <a href="#" className={styles.managerLink}>
      ...
      <div className={styles.footerBottom}>
        ...
        <img
          src="https://cdn.builder.io/api/v1/image/assets/3a5ff2c7562e4764a5a85cb40d9ea963/0f33013c78c13e893b62025eee4a792f45759517?apiKey=3a5ff2c7562e4764a5a85cb40d9ea963&"
          alt="Social media"
