...
const PlaceCard = ({ place, translate, isAuthenticated, handleViewMoreDetails=() => {}, isPopup=false }) => {
  return (
    <>
    {!isPopup && 
      <button
      ...
      <div className= {`${styles.placeCard} ${isPopup ? styles.popupPlaceCard : ""}`}>
        ...
        {!isPopup &&  <div className={styles.placeActions}>
         <button className={styles.viewMoreButton} onClick={() => handleViewMoreDetails(place?.id)} >{translate("placeCard.view_more")}</button>
